...
describe("game.rules.map.helper", function()
  ...
  it("returns terrain.blank when requesting out of range", function()
    ...
    assert.equals(terrain.list.blank, m:getTerrain(6, 3))
    assert.equals(terrain.list.blank, m:getTerrain(3, 6))
    assert.equals(terrain.list.blank, m:getTerrain(-1, 3))
    assert.equals(terrain.list.blank, m:getTerrain(6, 53))
    assert.equals(terrain.list.blank, m:getTerrain(0, 0))
    assert.equals(terrain.list.blank, m:getTerrain(0, 3))
    assert.equals(terrain.list.blank, m:getTerrain(1, 0))
  end)
end)
...
describe("game.rules.map", function()
  ...
  it("defines actions available", function()
    ...
    assert.not_nil(Map.actions.addEnemySpawner)
    assert.not_nil(Map.actions.removeEnemySpawner)
  end)

  it("defines the selectors available", function()
    assert.not_nil(Map.selectors.getDimensions)
    assert.not_nil(Map.selectors.getEnemySpawners)
    assert.not_nil(Map.selectors.getEnemySpawnerAt)

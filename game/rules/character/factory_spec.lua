...
describe("game.rules.character.character", function()
  ...
  it("sets up default attributes", function()
    ...
    assert.in_range(3, 18, c.attributes[attributes.dexterity])
    assert.in_range(3, 18, c.attributes[attributes.endurance])
    assert.in_range(3, 18, c.attributes[attributes.intelligence])
    assert.in_range(3, 18, c.attributes[attributes.knowledge])
    assert.in_range(3, 18, c.attributes[attributes.charisma])
  end)

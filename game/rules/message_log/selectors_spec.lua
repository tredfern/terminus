...
describe("game.rules.message_log.selectors", function()
  local Selectors = require "game.rules.message_log.selectors"

  describe("SELECTOR: getLast", function()
    it("gets the last x number of entries from state", function()
      ...
      local results = Selectors.getLast(state, 5)
    ...
    it("returns an empty array if no message_log state", function()
      local results = Selectors.getLast({}, 19)
